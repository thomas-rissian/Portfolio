...
Il y avait comme objectif de mettre en place une plateforme de ticket (GLPI), et de pouvoir récupérer des informations logicielles avec OCS Inventory.
L'OCS inventory et GLPI sur un serveur fedora et une version cliente d'OCS Inventory afin de récupérer les informations liées à la machine.
...
![Mon image](./theme/images/article/glpi/glpi_list.png)
...
![Mon image](./theme/images/article/glpi/OCS.png)
...
Création d'un tutoriel sur l'installation mais aussi la prise en main de certaines fonctionnalités sur GLPI comme la création de ticket lié à un appareil spécifique ou bien l'attribution du ticket à une catégorie précise.
Ce tutoriel avait pour rôle d'être le plus précis et compréhensible pour tout type d'utilisateur.